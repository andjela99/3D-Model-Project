...
int main() {
   ...
   //andjela
    unsigned  int floorTexture = loadTexture(FileSystem::getPath("resources/textures/kanta.png").c_str());
    ...
    stbi_set_flip_vertically_on_load(true);
     ...
     //andjela
     glm::vec3 lightPos(6.0f, 7.0f, 6.0f);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //andjela
        kantaShader.setVec3("viewPos", programState->camera.Position);
        kantaShader.setVec3("lightPos", lightPos);
